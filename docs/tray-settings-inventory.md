...
|---|---|---|---|
| `ingest.autoEject: bool` (default `false`) | **Yes** (`IngestConfig.AutoEject`, `config.go:455`) | M5 #87 | Graduated: `SettingsView.AutoEject` + `SetBool("ingest.autoEject", ...)` (settings.go:239, settingsmenu.go:74) |
