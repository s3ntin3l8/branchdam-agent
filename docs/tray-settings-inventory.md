...
| `ingest.autoImportPaths: []string` (default `[]`) | **Yes** (`IngestConfig.AutoImportPaths`, `config.go:451`) | M5 #79 | Graduated: `SettingsView.AutoImportPaths` + list-editing dialog (same shape as `AllowedExtensions`) |
